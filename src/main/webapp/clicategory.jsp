...
<body class="app">
	...
	<header class="app-header fixed-top">
	  ...
	  <path
						...
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link active" href="clicategory.jsp"> <span
							...
							<div
								...
								<div class="col-auto">
									<form class="table-search-form row gx-1 align-items-center"
										action="CliSearchCategory" method="post">
										<div class="col-auto">
											<input type="text" id="search-orders" name="name"
					...
					<div class="col-12 col-md-12">
						<div class="app-card app-card-settings shadow-sm p-4">
							<div class="app-card-body">
								<form class="settings-form" action="CliAddCategory"
									method="post">
									<div class="row">
										<div class="mb-3 col-4">
											<label for="setting-input-2" class="form-label">Name
										...
										<div class="mb-3 col-8">
											...
											<textarea class="form-control" name="description"
												id="setting-input-4" required></textarea>
										</div>
									</div>
									<div class="row">
												...
												<c:forEach var="dto" items="${result}">
													<tr>
														...
														<c:if test="${dto.get(3) == 1}">
															<td class="cell"><a
																href="CliCategoryActive?idCategory=${dto.get(0)}&status=${dto.get(3)}"><span
														...
														<td class="cell"><a class="btn-sm app-btn-secondary"
															href="CliEditCategory?idCategory=${dto.get(0)}">edit</a></td>
													</tr>
												</c:forEach>
											</c:if>
