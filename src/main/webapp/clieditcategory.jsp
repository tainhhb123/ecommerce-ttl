...
<body class="app">   
    ...
    <header class="app-header fixed-top">	   	            
	  ...
	  <path d="M6 0h7a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2v-1a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1H4a2 2 0 0 1 2-2z"/>
						...
						<li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link active" href="clicategory.jsp">
						        <span class="nav-icon">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Categorys</h1>
				    </div>
				    <div class="col-auto">
				...
				<div class="row g-4 settings-section mb-5">
					<div class="col-12 col-md-12">
						<div class="app-card app-card-settings shadow-sm p-4">
							...
							<c:set var="dto" value="${requestScope.category}" />
											<c:if test="${not empty dto}">
												
								<form class="settings-form" action="CliEditCategory" method="post">
									<div class="row">
									<input type="hidden" value="${dto.get(0)}" name="idCate">
									<div class="mb-3 col-4">
										<label for="setting-input-2" class="form-label">Name Category</label>
										<input type="text" name="name" value="${dto.get(1)}" class="form-control" id="setting-input-2" required>
									</div>
									<div class="mb-3 col-8">
										<label for="setting-input-4" class="form-label">Description</label>
										<textarea class="form-control" style="height: 200px"  name="description" id="setting-input-4" required>${dto.get(2)}</textarea>
									</div>
									</div>
									<div class="row">
									<div class="form-check form-switch ms-3 col-1">
										...
										<c:if test="${dto.get(3) == 0}">
												<input class="form-check-input" name="status"  type="checkbox" id="settings-switch-1" >
												</c:if>
									...
									<div class="col-6">
									<button type="submit" class="btn app-btn-primary ">Edit Category</button>
								</div>
								</div>
								</form>
