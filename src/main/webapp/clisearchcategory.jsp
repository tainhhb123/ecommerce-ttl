...
<body class="app">   
 <%
	Dao dao = new Dao();
	Vector listC = dao.getCategoryOfShopByName(request,(String) request.getAttribute("name"));
	%> 	
				    ...
				    <div class="col-auto">
					     <div class="page-utilities">
						    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
							    <div class="col-auto">
								    <form class="table-search-form row gx-1 align-items-center"action="CliSearchCategory" method="post">
					                    <div class="col-auto">
							        ...
							        <table class="table app-table-hover mb-0 text-left">
										...
										<c:set var="result" value="<%=listC%>" />
											...
											<tr>
												...
												<td class="cell"><a href="CliCategoryActive?idCategory=${dto.get(0)}&status=${dto.get(3)}"><span class="badge bg-success">Hide</span></a></td>
												</c:if>
												<c:if test="${dto.get(3) == 0}">
												<td class="cell"><a href="CliCategoryActive?idCategory=${dto.get(0)}&status=${dto.get(3)}"><span class="badge bg-danger">Active</span></a></td>
												</c:if>
