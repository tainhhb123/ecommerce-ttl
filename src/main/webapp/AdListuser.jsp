    ...
    <path fill-rule="evenodd" d="M8 5.754a2.246 2.246 0 1 0 0 4.492 2.246 2.246 0 0 0 0-4.492zM4.754 8a3.246 3.246 0 1 1 6.492 0 3.246 3.246 0 0 1-6.492 0z"/>
        ...
        <div id="app-sidepanel" class="app-sidepanel sidepanel-hidden"> 
          ...
          <path fill-rule="evenodd" d="M13 2.5V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
                        ...
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <a class="nav-link" href="AdUserServlet">
                                <span class="nav-icon">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		  ...
		  <path fill-rule="evenodd" d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
			    ...
			    <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
                    ...
                    <a class="flex-sm-fill text-sm-center nav-link"  id="orders-shop-tab" data-bs-toggle="tab" href="#orders-shop" role="tab" aria-controls="orders-shop" aria-selected="false">Shop</a>
				...
				<h2>Lists User</h2>
				<%
				    java.util.List<model.AdUser> users = (java.util.List<model.AdUser>) request.getAttribute("userList");
				...
				<div class="tab-content" id="orders-table-tab-content">
                    ...
                    <!-- shop -->
                    <div class="tab-pane fade" id="orders-shop" role="tabpanel" aria-labelledby="orders-shop-tab">
                    <div class="app-card app-card-orders-table shadow-sm mb-5">
                        <div class="app-card-body">
                            <div class="table-responsive">
                                <table class="table app-table-hover mb-0 text-left">
