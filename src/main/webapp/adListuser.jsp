...
<body class="app">
						...
						<div class="app-utilities col-auto">
							<div class="app-utility-item app-notifications-dropdown dropdown">
								<a class="dropdown-toggle no-toggle-arrow"
									...
									title="Notifications"> <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
    ...
    <path fill-rule="evenodd"
							...
							<div class="app-utility-item">
								<a href="settings.jsp" title="Settings"> <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
									<svg width="1em" height="1em" viewBox="0 0 16 16"
    ...
    <path fill-rule="evenodd"
							...
							<div class="app-utility-item app-user-dropdown dropdown">
								...
								<ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
									...
									<li><a class="dropdown-item" href="adLogin.jsp">Log
											Out</a></li>
								</ul>
							</div>
							<!--//app-user-dropdown-->
		...
		<div id="app-sidepanel" class="app-sidepanel sidepanel-hidden">
				...
				<nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
					<ul class="app-menu list-unstyled accordion" id="menu-accordion">
						<li class="nav-item">
							...
							class="nav-link" href="adIndex.jsp"> <span class="nav-icon">
									<svg width="1em" height="1em" viewBox="0 0 16 16"
          ...
          <path fill-rule="evenodd"
						...
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link" href="adShop.jsp"> <span class="nav-icon">
									<svg xmlns="http://www.w3.org/2000/svg" width="1em"
										height="1em" fill="currentColor" class="bi bi-shop-window"
										viewBox="0 0 16 16">
                                        <path
							...
							</span> <span class="nav-link-text">Shop</span>
						</a>
						<!--//nav-link-->
						</li>
						<!--//nav-item-->
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link" href="adPost.jsp"> <span class="nav-icon">
									<svg xmlns="http://www.w3.org/2000/svg" width="1em"
							...
							</span> <span class="nav-link-text">Posts</span>
						</a>
						<!--//nav-link-->
						</li>
						<!--//nav-item-->
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link" href="AdUserServlet"> <span class="nav-icon">
							...
							</span> <span class="nav-link-text">Lists User</span>
						</a>
						<!--//nav-link-->
						</li>
						<!--//nav-item-->
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link" href="adOrders.jsp"> <span class="nav-icon">
									<svg width="1em" height="1em" viewBox="0 0 16 16"
    ...
    <circle cx="3.5" cy="10.5" r=".5" />
						...
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link" href="adVoucher.jsp"> <span class="nav-icon">
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
										fill="currentColor" class="bi bi-ticket-fill"
										viewBox="0 0 16 16">
                                        <path
							...
							</span> <span class="nav-link-text">Voucher</span>
						</a>
						<!--//nav-link-->
						</li>
						<!--//nav-item-->
						...
						<!--//nav-link-->
							<div id="submenu-1" class="collapse submenu submenu-1 show"
								...
								<ul class="submenu-list list-unstyled">
									...
									<li class="submenu-item"><a class="submenu-link"
										href="account.jsp">Account</a></li>
									<li class="submenu-item"><a class="submenu-link active"
										href="settings.jsp">Settings</a></li>
      ...
      <path fill-rule="evenodd"
							...
							</span> <span class="nav-link-text">External</span> <span
								class="submenu-arrow"> <svg width="1em" height="1em"
										viewBox="0 0 16 16" class="bi bi-chevron-down"
										fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <path fill-rule="evenodd"
						...
						<!--//nav-link-->
							<div id="submenu-2" class="collapse submenu submenu-2"
								...
								<ul class="submenu-list list-unstyled">
									...
									<li class="submenu-item"><a class="submenu-link"
										href="reset-password.jsp">Reset password</a></li>
									<li class="submenu-item"><a class="submenu-link"
										href="404.jsp">404 page</a></li>
								</ul>
							</div>
						</li>
						<!--//nav-item-->
						...
						<li class="nav-item">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a
							class="nav-link" href="charts.jsp"> <span class="nav-icon">
									<svg width="1em" height="1em" viewBox="0 0 16 16"
										class="bi bi-bar-chart-line" fill="currentColor"
										xmlns="http://www.w3.org/2000/svg">
      <path fill-rule="evenodd"
							...
							<div
								...
								<div class="col-auto">
									<form class="table-search-form row gx-1 align-items-center"
										method="get" action="AdSearchUser">
										<div class="col-auto">
											<input type="text" id="search-orders" name="searchuser"
		  ...
		  <path fill-rule="evenodd"
				...
				<nav id="orders-table-tab"
					...
					<a class="flex-sm-fill text-sm-center nav-link"
						id="orders-shop-tab" data-bs-toggle="tab" href="#orders-shop"
						role="tab" aria-controls="orders-shop" aria-selected="false">Shop</a>
					<a class="flex-sm-fill text-sm-center nav-link"
						id="orders-paid-tab" data-bs-toggle="tab" href="#orders-paid"
						role="tab" aria-controls="orders-paid" aria-selected="false">Users</a>
					<a class="flex-sm-fill text-sm-center nav-link"
...
<div class="tab-content" id="orders-table-tab-content">
        ...
        <div class="app-card app-card-orders-table shadow-sm mb-5">
            <div class="app-card-body">
                <div class="table-responsive">
                            ...
                            <c:choose>
                                <c:when test="${not empty searchResults}">
                                    <c:forEach var="user" items="${searchResults}">
                                        <tr>
                                            <td class="cell">${user.fullName}</td>
                                            <td class="cell"><span class="truncate">${user.userName}</span></td>
                                            <td class="cell">${user.email}</td>
                                            <td class="cell">${user.phoneNumber}</td>
                                            <td class="cell">${user.dateOfBirth}</td>
                                            <td class="cell">
                                                <c:choose>
                                                    <c:when test="${user.roleName == 'admin'}">
                                                        <a href="#"><span class="badge bg-primary">Admin</span></a>
                                                    </c:when>
                                                    <c:when test="${user.roleName == 'customer'}">
                                                        <a href="#"><span class="badge bg-info">Customer</span></a>
                                                    </c:when>
                                                    <c:when test="${user.roleName == 'client'}">
                                                        <a href="#"><span class="badge bg-warning">Client</span></a>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <a href="#"><span class="badge bg-secondary">Unknown</span></a>
                                                    </c:otherwise>
                                                </c:choose>
                                            </td>
                                          <td>
							...
							<ul class="pagination justify-content-center">
									...
									<li class="page-item"><a class="page-link"
										href="<c:choose>
						                    <c:when test="${not empty searchQuery}">
						                        AdSearchUser?page=${currentPage - 1}&searchuser=${searchQuery}
						                    </c:when>
						                    <c:otherwise>
						                        AdUserServlet?page=${currentPage - 1}
						                    </c:otherwise>
						                </c:choose>"
								...
								<c:forEach begin="1" end="${totalPages}" var="i">
									<li class="page-item ${i == currentPage ? 'active' : ''}">
										...
										href="<c:choose>
						                    <c:when test="${not empty searchQuery}">
						                        AdSearchUser?page=${i}&searchuser=${searchQuery}
						                    </c:when>
						                    <c:otherwise>
						                        AdUserServlet?page=${i}
						                    </c:otherwise>
						                </c:choose>">${i}</a>
									</li>
								</c:forEach>
					...
					<!--//tab-pane-->
					<!-- shop -->
					<div class="tab-pane fade" id="orders-shop" role="tabpanel"
						aria-labelledby="orders-shop-tab">
						<div class="app-card app-card-orders-table shadow-sm mb-5">
							<div class="app-card-body">
								<div class="table-responsive">
									<table class="table app-table-hover mb-0 text-left">
										...
										<tbody>
											<tr>
												<td class="cell">Tráº§n Táº¥n TÃ i</td>
												<td class="cell"><span class="truncate">tainhhb123</span></td>
												<td class="cell">trantantai310803@gmail.com</td>
												<td class="cell">0389093655</td>
												<td class="cell">31/08/2003</td>
												<td class="cell"><button class="badge bg-info">Shop</button></td>
	...
	<script src="assets/js/status-user.js"></script>
