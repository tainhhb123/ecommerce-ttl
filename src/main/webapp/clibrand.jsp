 ...
 <%
    ...
    <header class="app-header fixed-top">	   	            
	  ...
	  <path d="M6 0h7a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2v-1a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1H4a2 2 0 0 1 2-2z"/>
						...
						<li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link active" href="clibrand.jsp">
						        <span class="nav-icon">
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file" viewBox="0 0 16 16">
										<path d="M4 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2zm0 1h8a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1"/>
									  </svg>
				    ...
				    <div class="col-auto">
					     <div class="page-utilities">
						    <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
							    <div class="col-auto">
								    <form class="table-search-form row gx-1 align-items-center" action="CliSearchBrand" method="post">
					                    <div class="col-auto">
					                        <input type="text" id="search-orders" name="name" class="form-control search-orders" placeholder="Search">
					                    </div>
					                    <div class="col-auto">
					                        <button type="submit" class="btn app-btn-secondary"><i class="bi bi-search"></i></button>
					                    </div>
					                </form>
					...
					<div class="col-12 col-md-12">
						<div class="app-card app-card-settings shadow-sm p-4">
							<div class="app-card-body">
								<form class="settings-form" action="CliAddBrand" method="post">
									<div class="row">
									<div class="mb-3 col-4">
										<label for="setting-input-2" class="form-label">Name Brand</label>
										<input type="text" class="form-control" name="name" id="setting-input-2" required>
									</div>
									<div class="mb-3 col-8">
										<label for="setting-input-4" class="form-label">Country</label>
										<input class="form-control" name="country" id="setting-input-4" required>
									</div>
									</div>
									<div class="row">
									<div class="form-check form-switch ms-3 col-1">
										<input class="form-check-input" name="status" type="checkbox" id="settings-switch-1" checked>
										<label class="form-check-label ms-1" for="settings-switch-1">Status</label>
									</div>
									<div class="col-6">
									<button type="submit" class="btn app-btn-primary ">Add Brand</button>
								</div>
								</div>
								</form>
							        ...
							        <table class="table app-table-hover mb-0 text-left">
										...
										<tbody>
											...
											<tr>
												...
												<c:if test="${dto.get(3) == 1}">
												<td class="cell"><a href="CliBrandActive?idBrand=${dto.get(0)}&status=${dto.get(3)}"><span class="badge bg-success">Hide</span></a></td>
												</c:if>
												<c:if test="${dto.get(3) == 0}">
												<td class="cell"><a href="CliBrandActive?idBrand=${dto.get(0)}&status=${dto.get(3)}"><span class="badge bg-danger">Active</span></a></td>
												</c:if>
												<td class="cell"><a class="btn-sm app-btn-secondary" href="CliEditBrand?idBrand=${dto.get(0)}">edit</a></td>
											</tr>
											</c:forEach>
											</c:if>
