    ...
    <header class="app-header fixed-top">	   	            
		            ...
		            <div class="app-utilities col-auto">
			            <div class="app-utility-item app-user-dropdown dropdown">
				            ...
				            <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
								...
								<li><a class="dropdown-item" href="cusindex"><i class="bi bi-arrow-left-right"></i> Customer</a></li>
	  ...
	  <path d="M6 0h7a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2v-1a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H6a1 1 0 0 0-1 1H4a2 2 0 0 1 2-2z"/>
					        ...
					        <div id="submenu-1" class="collapse submenu submenu-1 " data-bs-parent="#menu-accordion">
						        <ul class="submenu-list list-unstyled">
							        ...
							        <li class="submenu-item"><a class="submenu-link" href="account.jsp">Add Product</a></li>
	  ...
	  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
					        ...
					        <div id="submenu-2" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
						        <ul class="submenu-list list-unstyled">
							        <li class="submenu-item"><a class="submenu-link" href="login.jsp">List Voucher</a></li>
							        <li class="submenu-item"><a class="submenu-link" href="signup.jsp">Add Voucher</a></li>
						        </ul>
					        </div>
					    </li><!--//nav-item-->					    
