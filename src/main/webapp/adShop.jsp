	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Shop</h1>
				    </div>
				    <div class="col-auto">
							        ...
							        <table class="table app-table-hover mb-0 text-left">
										<thead>
											<tr>
												...
												<th class="cell">Total Category</th>
										...
										<tbody>
											...
											<tr>
                                                ...
                                                <td class="cell"></td>
                                                <td class="cell"><button class="badge bg-success"></button></td>	
												<td class="cell"><a class="btn-sm app-btn-secondary" href="AdProduct.jsp">View</a></td>		
